...
(function(){
    ...
    Preview.prototype = {
        ...
        init: function(){
            ...
            this.imgBg.innerHTML = '<span style="position: absolute;top: 50px;right:50px;z-index: 10;height: 36px;width: 36px;cursor:pointer;border-radius:50%;border:2px solid #fff" class="close_bgmask"></span><div style="position:absolute;left:50%;top:50%;" class="view_img_wrap"><img style="width:100%;height:100%;position: relative;z-index: -1;" src="" alt=""></div>';
